...
# Hyperparameters
input_dim = 200
output_dim = 100  # Ensuring output space is 100 (0-99 actions)
num_episodes = 50000
num_steps = 5
learning_rate = 0.001
...
best_model_path = r"D:\Users\YUTO\Documents\pg20\year 5\Model\Machine Learning\Reinforcement Learning Models\250403_Study_A_Variation_14.pth"
...
class QNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(128, output_dim)  # Output size is 100 (0-99 actions)
        )
