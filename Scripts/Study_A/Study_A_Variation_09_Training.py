...
class PPOActorCritic(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.fc1 = nn.Linear(input_dim, 8)  # First hidden layer with 8 neurons
        self.fc2 = nn.Linear(8, 4)  # Second hidden layer with 4 neurons
        self.actor = nn.Linear(4, output_dim)  # Policy output (2 possible actions)
        self.critic = nn.Linear(4, 1)  # Value function output (1 value)
...
lambda_ = 0.95
num_episodes = 1000
num_steps_per_episode = 256  # Define the number of steps per episode
...
# Save best model
torch.save(best_model, "D:/Users/YUTO/Documents/pg20/year 5/Model/Machine Learning/Reinforcement Learning Models/250403_Study_A_Variation_09.pth")
