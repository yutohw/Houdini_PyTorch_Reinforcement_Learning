...
# ===========================
GEO_NODE = "/obj/Massing_Solar_Environment_27"
...
class PPOActorCritic(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.fc1 = nn.Linear(input_dim, 1024)  # Increased width
        self.fc2 = nn.Linear(1024, 512)  # Increased width
        self.fc3 = nn.Linear(512, 256)  # Added an extra layer
        self.fc4 = nn.Linear(256, 64)  # Added an extra layer
...
def compute_gae(rewards, values, gamma=0.99, lambda_=0.9):
    advantages = []
    gae = 0
...
# Training Loop
# ===========================
model = PPOActorCritic(input_dim=INPUT_DIM, output_dim=OUTPUT_DIM)
